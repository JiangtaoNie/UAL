...
class LoadDataset(data.Dataset):
    def __init__(self, Path, datasets='CAVE', patch_size=128, stride=64, Data_Aug=False, up_mode='bicubic', Normlization=0, Train_num_start=0,Train_image_num=12):
        ...
        self.Start_num = Train_num_start
    ...
    def __getitem__(self, Index):
        ...
        Data = sio.loadmat(self.path+self.names[Image_I + self.Start_num]+'.mat')
